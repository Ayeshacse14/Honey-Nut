...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="{{asset('images/slideshow/'. 'huny1.jpg')}}"  alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="{{asset('images/slideshow/'. 'huny4.jpg')}}"  alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="{{asset('images/slideshow/'. 'huny3.jpg')}}" alt="Third slide">
    </div>
  </div>
 ...
 <div class="row">
   <div class="col col-md-4">
    <div class="card" style="width: 19rem;">
        <img class="card-img-top" src="{{asset('images/slideshow/'. 'huny1.jpg')}}" alt="Card image cap">
          <div class="card-body">
   ...
   <div class="col col-md-4">
    <div class="card" style="width: 19rem;">
        <img class="card-img-top" src="{{asset('images/slideshow/'. 'huny4.jpg')}}" alt="Card image cap">
          <div class="card-body">
   ...
   <div class="col col-md-4">
    <div class="card" style="width: 19rem;">
        <img class="card-img-top" src="{{asset('images/slideshow/'. 'huny3.jpg')}}" alt="Card image cap">
          <div class="card-body">
